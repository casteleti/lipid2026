...
interface TechnologyProjectFormProps {
...
/**
 * Formulário das landings de tecnologia. Mesmo padrão visual do formulário de segmento
 * (glass escuro), mas sem setor fixo — uma página de tecnologia recebe visitante de
 * qualquer indústria, então o setor é perguntado em vez de presumido, e é o
 * `landingRoute` que identifica a página no relatório de conversão.
 */
    ...
    >
      <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
        <div className="space-y-1.5">
          <label htmlFor="tec-nome" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
            Nome
          </label>
          <input
            id="tec-nome"
        ...
        <div className="space-y-1.5">
          <label htmlFor="tec-empresa" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
            Empresa
          </label>
          <input
            id="tec-empresa"
        ...
        <div className="space-y-1.5">
          <label htmlFor="tec-cargo" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
            Cargo ou área
          </label>
          <input
            id="tec-cargo"
            ...
            disabled={enviando}
            className={campoBase}
            placeholder="Ex.: P&D, inovação, regulatório"
          />
        </div>

        <div className="space-y-1.5">
          <label htmlFor="tec-setor" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
            Segmento
          </label>
          <select
            id="tec-setor"
            ...
            disabled={enviando}
            className={`${campoBase} [&>option]:text-gray-900`}
          >
        ...
        <div className="space-y-1.5">
          <label htmlFor="tec-email" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
            E-mail
          </label>
          <input
            id="tec-email"
        ...
        <div className="space-y-1.5">
          <label htmlFor="tec-telefone" className="block text-xs font-semibold uppercase tracking-wide text-white/60">
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          disabled={enviando}
          className={campoBase}
          placeholder="Ativo, forma pretendida, estágio do projeto, o que precisa melhorar..."
        />
      </div>
