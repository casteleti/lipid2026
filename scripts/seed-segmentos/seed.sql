...
INSERT INTO segment_pages (
  ...
  '["Na farmacêutica, o ingrediente decide estabilidade, processabilidade e viabilidade industrial. Ele não é só mais um item da fórmula.", "Partimos da forma farmacêutica, do ativo, do processo e da exigência regulatória para indicar famílias, graus e sistemas de entrega compatíveis.", "O resultado é uma formulação mais robusta, documentada e pronta para escala — com diferencial técnico defensável diante dos concorrentes."]'::jsonb,
...
INSERT INTO segment_pages (
  ...
  '["Em cosméticos, a diferenciação nasce do encontro entre ciência, sensorial e estabilidade. E precisa sustentar a promessa do rótulo.", "Consideramos o ativo, a base, o processo e a textura desejada para indicar ingredientes que funcionem na bancada e também na linha.", "O ganho é um produto com desempenho comprovável e história técnica própria, em vez de mais um lançamento premium na prateleira."]'::jsonb,
...
INSERT INTO segment_pages (
  ...
  '["O mercado nutricional cobra produto consistente, viável em escala e com um diferencial que o consumidor realmente perceba.", "Analisamos a matriz, a dose, a forma de apresentação e o processo antes de indicar lecitinas, fosfolipídios ou sistemas funcionais.", "O objetivo é tirar o produto da disputa por preço, sustentando valor com função real e argumento técnico que se defende."]'::jsonb,
...
INSERT INTO segment_pages (
  ...
  '["Desenvolvimento veterinário exige olhar espécie, via de administração, estabilidade e rotina de uso ao mesmo tempo.", "Trabalhamos a partir do desafio concreto: proteger um ativo, melhorar a dispersão, viabilizar uma apresentação ou destravar o processo.", "O ganho é um produto tecnicamente defensável, que fortalece a marca e melhora a experiência de tutores, produtores e profissionais."]'::jsonb,
